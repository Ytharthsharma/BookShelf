...
import googleLogo from "../assets/gmail-logo.png"
	...
	<div className="relative py-3 sm:max-w-xl sm:mx-auto">
		...
		<div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
			<div className="max-w-md mx-auto">
				<div>
					<h1 className="text-2xl font-semibold">Sign Up Below !!</h1>
				</div>
				<div className="divide-y divide-gray-200">
					<form onSubmit={handleSignUp} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                        ...
                        <p>If You Have an Account. Please <Link to="/login" className='text-yellow-300 underline'>Login</Link> Here </p>
						<div className="relative">
							<button className="bg-yellow-300 text-white rounded-md px-6 py-2">Sign Up</button>
						</div>
					</form>
				</div>
				<hr/>
